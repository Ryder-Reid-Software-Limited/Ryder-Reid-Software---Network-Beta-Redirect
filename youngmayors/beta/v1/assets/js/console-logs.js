console.log("%c©️ 2024 Young Mayors of Horsham Victoria, Software provided and supported by Ryder Reid Software", "color: black; font-size: 15px;, font-weight: bold;");
